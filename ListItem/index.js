  ...
  function LeftActions(progress, dragX){
    ...
    return(
      <View style={styles.leftAction}>
        <Animated.Text style={[styles.actionText, { transform: [{ scale }] }]}>Pedir/Aceitar atendimento</Animated.Text>
      </View>
    );
  }
  ...
  function RightActions({progress, dragX, onPress}){
    ...
    return(
      <TouchableOpacity onPress={onPress} style={styles.rightAction}>
        ...
        <Animated.Text style={[styles.actionText, { transform: [{ scale }] }]}>Rejeitar Médico/Paciente</Animated.Text>
        </Animated.View>
      </TouchableOpacity>
    );
  }
